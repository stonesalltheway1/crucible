...
export async function runTier3Proof(
  ...
  const finding: Finding = {
    ...
    severity: "info",
    detail:
      "No mainstream TypeScript formal verifier wired in v1. Dispatcher should fall back to Tier 2.5 (exhaustive PBT + CODEOWNER review) per docs/01-architecture/verifier-pipeline.md.",
  };
